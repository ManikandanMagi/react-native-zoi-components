...
export default class CheckboxComponent extends Component {
  ...
  stateSwitcher(key, label, value) {
    ...
    if (this.props.onCheck != undefined) {
      this.props.onCheck(key, label, value)
         ...
         style={{
          ...
          <View style={{
          ...
          }}>
            {
              (this.state.checked)
                ?
                (<View style={{ ...styles.selectedUI, backgroundColor: this.props.fill == undefined ? "#FFF" : this.props.fill }}>
                  <Icon name="ios-checkmark-outline" size={30} color={this.props.tintColor == undefined ? this.props.color : this.props.tintColor} style={styles.checkboxTickImg} />
