...
//     _handleFocus = () => {
//         this.setState({ borderColor: "#af772d" })
...
//     _handleBlur = () => {
//         this.setState({ borderColor: "#e1e1e1", isvisible: false })
...
//     }
//     _handleiconpress = () => {
//         this.props.onPressicon != undefined &&
...
export class TextBoxComponent extends Component {
    ...
    _handleBlur = () => {
        this.setState({ borderColor: commoncolor.Gainsboro, isvisible: false })
